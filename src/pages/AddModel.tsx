      ...
      return (
        <form onSubmit={handleHomeSubmit} style={formStyle}>
          ...
          <FileInput
            ...
            accept="image/*"
            multiple
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => setHomeTextureFiles(e.target.files)}
          />
    ...
    return (
      <form onSubmit={handleCustomItemSubmit} style={formStyle}>
        ...
        <FileInput
          ...
          accept="image/*"
          multiple
          onChange={(e: React.ChangeEvent<HTMLInputElement>) => setItemTextureFiles(e.target.files)}
        />
